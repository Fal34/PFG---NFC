...
%Stakeholders and Interests: Who cares about this use case and what do they want?
\additemizedfield{\textit{Stakeholders} e interesados:}{
	\item Desarrollador: Revertir todos los cambios respecto a la definición por defecto.
}
%Preconditions: What must be true on start and worth telling the reader?
\additemizedfield{Precondiciones:}{
\item La aplicación se encuentra instalada en el dispositivo \textit{Android}.
...
%Postconditions: What must be true on successful completion and worth telling the reader
\additemizedfield{Postcondiciones:}{
\item La aplicación recupera la implementación del sistema por defecto.
}
%when multiple
%\additemizedfield{Preconditions:}{}
...
\addscenario{Escenario principal de éxito:}{
	...
	\item[7] Se muestra un cuadro de confirmación.	
	\item[8] Tras aceptar, se recupera el sistema por defecto.
}
...
%\begin{figure}[H]
%  \centering
%  \csubfloat{\includegraphics[width=0.35\textwidth]{./img/pantallaPrincipal}}
%  \centerhfill
%  \csubfloat{\includegraphics[width=0.35\textwidth]{./img/menuDesplegado}}
%  \hspace*{\fill}
...
\vspace{0.5515cm}
\\
El flujo se simplifica básicamente en asignar a los usuarios del sistema un punto $P$ aleatorio en una curva elíptica dentro de un campo finito $GF(2^m))$. Las curvas están delimitadas por un conjunto de nombres de curvas ya definidas que cumplen ciertas características de seguridad (orden de la curva de más de 130 \textit{bits}) y capacidad objetivo (codificaciones no superiores a la capacidad de las tarjetas NFC). Las curvas siguen diferentes estándares y se cargan en función del nombre que se les atribuye, el listado de las curvas disponibles se puede observar en \cite{bouncyCastleCurves} dentro de las correspondientes a los campos $GF(2^m)$.
\*
\vspace{0.5515cm}
\\
...
\begin{center}
$y^2 + xy= x^3 +ax^2 + b\ (mod\ n) \equiv E(GF(2^m))$\\
...
%\begin{figure}[H]
%  \centering
%  \subfloat{\includegraphics[width=0.35\textwidth]{./img/app/accesoMenu}}
%  \null\hfill
%  \subfloat{\includegraphics[width=0.35\textwidth]{./img/app/menuDesplegado}}
...
%\begin{figure}[H]
%  \centering
%  \subfloat{\includegraphics[width=0.35\textwidth]{./img/app/despliegueSistema}}
%  \null\hfill
%  \subfloat{\includegraphics[width=0.35\textwidth]{./img/app/despligueSistemaDialog}}
