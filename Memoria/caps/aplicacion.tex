...
%\begin{figure}[H]
%  \centering
%  \subfloat{\includegraphics[width=0.35\textwidth]{./img/app/despliegueBaseDeDatosDialog}}
%  \null\hfill
%  \subfloat{\includegraphics[width=0.35\textwidth]{./img/app/despliegueBaseDeDatosMensaje}}
...
%\begin{figure}[H]
%  \centering
%  \subfloat{\includegraphics[width=0.35\textwidth]{./img/app/nuevoUsuarioDialog}}
%  \null\hfill
%  \subfloat{\includegraphics[width=0.35\textwidth]{./img/app/nuevoUsuarioAgregado}}
...
%\begin{figure}[H]
%  \centering
%  \subfloat{\includegraphics[width=0.35\textwidth]{./img/app/verUsuarios}}
%  \null\hfill
%  \subfloat{\includegraphics[width=0.35\textwidth]{./img/app/nuevoUsuarioInsertado}}
...
%\begin{figure}[H]
%  \centering
%  \subfloat{\includegraphics[width=0.35\textwidth]{./img/app/validacionExitoEscrito}}
%  \null\hfill
%  \subfloat{\includegraphics[width=0.35\textwidth]{./img/app/validacionFallida}}
...
%\begin{figure}[H]
%  \centering
%  \subfloat{\includegraphics[width=0.35\textwidth]{./img/app/ValidacionExitoNoEscrito}}
%  \null\hfill
%  \subfloat{\includegraphics[width=0.35\textwidth]{./img/app/escrituraPostLectura}}
...
%\begin{figure}[H]
%  \centering
%  \subfloat{\includegraphics[width=0.45\textwidth]{./img/junitTest}}
%  \null\hfill
%  \subfloat{\includegraphics[width=0.5\textwidth]{./img/coveredCode}}
